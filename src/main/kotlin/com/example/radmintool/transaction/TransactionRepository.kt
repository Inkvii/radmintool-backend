...
interface TransactionRepository : JpaRepository<Transaction, Long> {
    ...
    fun findTransactionsByIdBetweenAndAmountBetweenAndPaidBy(idMin: Long, idMax: Long, amountMin: BigDecimal, amountMax: BigDecimal, paidBy: Person): List<Transaction>
}
